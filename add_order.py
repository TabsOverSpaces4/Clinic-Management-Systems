...
class add_book:
    def __init__(self,root):
        self.f=Frame(root.title("Add Doctor"),height=500,width=800,bg='dodgerblue3')

        self.f.propagate(0)

        self.f.pack()
        
        self.n=Label(text='DOCTOR DETAILS',fg="black",bg="dodgerblue3",font=('Calibri Bold',26))
        self.n1=Label(text='DOCTOR NAME:',fg="black",bg="dodgerblue3",font=('Calibri',14))
        self.n2=Label(text='CONTACT NUMBER:',fg="black",bg="dodgerblue3",font=('Calibri',14))
        self.n3=Label(text='DOCTOR ADDRESS:',fg="black",bg="dodgerblue3",font=('Calibri',14))
        # self.n7=Label(text=':',fg="black",bg="dodgerblue3",font=('Calibri',14))
        # self.n8=Label(text='',fg="black",bg="dodgerblue3",font=('Calibri',14))

        self.b1=Button(text='ADD APPOINTMENT',fg='white',bg='dark red',width=20,height=2,command=lambda: self.buttonclick(0))
